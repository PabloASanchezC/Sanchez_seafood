...
const API_URL = 'https://script.google.com/macros/s/AKfycbzEveVHVXl7PRDEaMyXlFp8z4MpHDQbEy2g6SED4VCwjhr44gJsRQUNi75WAbnqVOED/exec';
...
/**
 * Obtiene la lista de áreas desde la pestaña Catalogo_Sucursales
 */
async function cargarCatalogoSucursales() {
    const select = document.getElementById('sucursal');
    try {
        const response = await fetch(`${API_URL}?sheet=Catalogo_Sucursales`);
        ...
        console.error("Error en catálogo de sucursales:", error);
